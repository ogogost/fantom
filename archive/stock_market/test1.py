...
for _ in range(300):
    ...
    "\n Buys filled:"
    print
    exchange.buys_filled
    print
    "\n Sells filled:"
    print
    exchange.sells_filled
    print
    "\n\n\n"
    print
    "The buy book:\n"
    print
    exchange.buys_prices
    print
    "\n"
    print
    exchange.buys_info
...
sns.distplot(list(Buys.keys()), hist_kws={"weights": list(Buys.values())}, \
             kde=False, label="buys")
sns.distplot(list(Sells.keys()), hist_kws={"weights": list(Sells.values())}, \
             kde=False, label="sells")
